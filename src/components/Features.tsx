...
const Features = () => {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 bg-[#0c121e]">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-slate-900 border border-slate-800 px-4 py-1.5 rounded-full mb-4">
            ...
            <span className="text-xs font-semibold text-slate-300 uppercase tracking-wider">
              Módulos e Diretrizes Normativas
            </span>
          </div>
          ...
          <p className="text-base md:text-lg text-slate-300 max-w-2xl mx-auto font-normal">
            Projetado para a rotina prática de canteiro, unindo velocidade de preenchimento e rigor técnico das normas NBR 12655 e NBR 6118.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {features.map((feature, index) => (
            <Card 
              ...
              className="bg-slate-900/90 border border-slate-800 hover:border-blue-500/50 transition-all duration-300 shadow-lg cursor-pointer group"
            >
              <CardHeader>
                <div className="w-12 h-12 rounded-lg bg-slate-800/80 border border-slate-700/50 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-[#131d2e] to-slate-900 border border-slate-700/80 p-8 md:p-12 rounded-2xl text-center shadow-xl">
          ...
          <p className="text-base text-slate-300 mb-8 max-w-2xl mx-auto font-normal">
            Faça os primeiros registros de recebimento ou acompanhe o mapa da estrutura em tempo real.
          </p>
